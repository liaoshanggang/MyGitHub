        ...
        <div>
            ...
            <form class="m-t" role="form" action="user/login" method="post">
                <div class="form-group">
                    <input type="text" value="admin" class="form-control" placeholder="用户名" name="usrName"  required>
                </div>
                <div class="form-group">
                    <input type="password" value="admin" class="form-control" placeholder="密码" name="usrPassword" required>
                </div>
