 ...
 * @author james
 * 
 *         <form><form> JavaBean, Map<name, value>
 * 
 *         11 aaa bbb 20 ccc
 * 
 *         pageSize=10; 101条 11页 11~20 【第一页】【上一页】【下一页】【最后一页】 Page<Book> page =
 *         new Page<Book>();
 */
public class Page<T> {
	// 每页的行数
	...
	// 查询条件
	private T queryObject; // JavaBean, Map,...
	...
	/**
	 * @param totalRow
	 *            总记录数 默认每页显示5条 page.setPageSize(6); page.setTotalRow(10);
	 */
	...
	public int getFirstIndex() {
		int i = getPageNo();
		return ((i < 1 ? 1 : i) - 1) * getPageSize() + 1; // 1
	}
	...
	public int getLastIndex() {
		return getFirstIndex() + this.getPageSize() - 1; // 6
	}
	...
	public String toString() {
		return "Page [是否是第一页:" + getFirst() + ", 是否是最后页:" + getLast()
				+ ", 是否有上一页:" + getPrevious() + ", 是否有下一页:" + getNext()
				+ ",   当前的页号:" + getPageNo() + ",   每页记录数:" + getPageSize()
				+ ", 总页数=" + getTotalPage() + ", 总记录数=" + getTotalRow() + "]";
	}
	...
	public static void main(String[] args) {
		...
		page.setQueryObject(null); // 保存查询条件
