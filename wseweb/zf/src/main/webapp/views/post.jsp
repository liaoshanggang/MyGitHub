...
<script type="text/javascript">
	$(function() {
		...
		/* $("#smt").click(function(){
		     ...
		     console.info(idata);
			$.post("house/update?t="+new Date().getDate(),idata,function(data){
				$("#msg").text(data);
			},"json"); 
	...
	$(function() {
		...
		$("#message-alert button").click(function() {
	...
	<table width="780" border="0" align="center" cellpadding="0"
		...
		<tr>
			...
			<td width="495">
				...
				<form action="house/update" method="post" name="mf"
					...
					<table>
						...
						<tr>
							...
							<td><select id="district" name="district" style="width: 80">
							</select></td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="2">
								<div align="center">
									<input id="smt" type="submit" value="提交" class="btn">
								</div>
							</td>
						</tr>
						<tr id="message-alert"
							class="alert alert-success alert-dismissable alert-hide">
							<td><span id="message">成功！很好地完成了提交。</span></td>
