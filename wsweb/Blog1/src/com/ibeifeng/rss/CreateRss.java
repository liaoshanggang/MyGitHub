...
public class CreateRss {
	...
	public static void publishRss(List<Article> list, String filePath) {
		...
		try {
			...
			bw.write("<channel>\r\n");
			bw.write("<title>forward博客网</title>\r\n");
			bw.write("<link>http://localhost:8080/Blog1/login.jsp</link>\r\n");
			bw.write("<description>forward专注于forward</description>\r\n");
			
			for(Article art : list) {
				bw.write("<item>\r\n");
				bw.write("<title>" + art.getTitle()+"</title>\r\n");
				bw.write("<link>http://localhost:8080/Blog1/user/showArticle.action?id = " + art.getId() + "</link>\r\n");
